...
- `.agentboard/goals/<goal_id>/phases/frame.md` — `riskiest_assumption`, `key_assumptions`, `non_goals`, `success_definition`
- `.agentboard/goals/<goal_id>/phases/arch.md` — `critical_files`, `edge_cases`, `test_strategy`, `critical_path`, `out_of_scope_guard`, `design_review` section if `ui_surface=true`
...
Write `.agentboard/goals/<goal_id>/phases/challenge.md`:
...
3. Output:
   ...
   저장: .agentboard/goals/{goal_id}/phases/challenge.md
