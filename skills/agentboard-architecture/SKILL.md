...
- `.agentboard/goals/<goal_id>/phases/frame.md` — `problem`, `wedge`, `non_goals`, `success_definition`, `key_assumptions`, `riskiest_assumption`, `new_risk_invalidates_scope`
...
Write `.agentboard/goals/<goal_id>/phases/arch.md`:
