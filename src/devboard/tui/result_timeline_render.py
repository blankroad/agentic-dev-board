...
_DELIVERABLE_BUCKETS: tuple[tuple[str, str], ...] = (
    ("src/devboard/tui/overview_render", "Overview renderer"),
    ("src/devboard/tui/dev_timeline_render", "Dev renderer"),
    ("src/devboard/tui/result_timeline_render", "Result renderer"),
    ("src/devboard/tui/review_sections_render", "Review renderer"),
    ("src/devboard/tui/phase_flow", "PhaseFlowView integration"),
    ("src/devboard/tui/app", "app-level bindings"),
    ("src/devboard/analytics/overview_payload", "OverviewPayload builder"),
    ("src/devboard/analytics/iter_diffstat", "numstat parser"),
    ("src/devboard/mcp_server", "MCP tool registration"),
